...
class API {
  ...
  get(url, options = {}) {
    ...
    this.request = nodeFetch(`${this.baseUrl}${url}${params}`, {
      method: 'GET',
      headers: {
        ...this.defaultHeaders,
        ...options.headers,
  ...
  post(url, options = {}) {
    this.request = nodeFetch(`${this.baseUrl}${url}`, {
      method: 'POST',
...
function createQueryFromObject(object) {
...
module.exports = function fetch(baseUrl) {
